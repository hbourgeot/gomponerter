        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                <p>
                Copy any HTML Element with children nodes and paste it into the
                left textarea and click on <span className="italic">Send HTML</span> button to convert it
                into a{" "}
                <a
                ...
                <p className="my-2">
                  <span className="text-destructive">NOTE:</span> if the HTML provided has many root elements, only the first would be considered and the rest ignored
                </p>
              </AlertDialogDescription>
              <AlertDialogDescription>
                Made with love by hbourgeot using Wails
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
